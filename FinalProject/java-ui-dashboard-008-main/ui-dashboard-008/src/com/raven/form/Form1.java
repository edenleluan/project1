...
public class Form1 extends javax.swing.JPanel {
    ...
    private void init() {
        barChart.addLegend("Anomaly Type", new Color(12, 84, 175), new Color(0, 108, 247));
        barChart.addLegend("Actvity", new Color(54, 4, 143), new Color(104, 49, 200));
        barChart.addLegend("Source", new Color(5, 125, 0), new Color(95, 209, 69));
        barChart.addLegend("Destination", new Color(186, 37, 37), new Color(241, 100, 120));
        ...
        barChart.start();
        lineChart.addLegend("Anomaly Type", new Color(12, 84, 175), new Color(0, 108, 247));
        lineChart.addLegend("Activty", new Color(54, 4, 143), new Color(104, 49, 200));
        lineChart.addLegend("Source", new Color(5, 125, 0), new Color(95, 209, 69));
        lineChart.addLegend("Destination", new Color(186, 37, 37), new Color(241, 100, 120));
    ...
    private void initComponents() {
        ...
        panelShadow4Layout.setHorizontalGroup(
            ...
            .addGroup(panelShadow4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lineChart, javax.swing.GroupLayout.PREFERRED_SIZE, 1064, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        panelShadow4Layout.setVerticalGroup(
            ...
            .addGroup(panelShadow4Layout.createSequentialGroup()
                .addGap(16, 16, 16)
                .addComponent(lineChart, javax.swing.GroupLayout.PREFERRED_SIZE, 311, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel23.setFont(new java.awt.Font("sansserif", 1, 60)); // NOI18N
        jLabel23.setForeground(new java.awt.Color(255, 255, 255));
        jLabel23.setText("OBSTRUCTION");
        ...
        panelShadow5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelShadow5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(barChart, javax.swing.GroupLayout.DEFAULT_SIZE, 1447, Short.MAX_VALUE)
                .addContainerGap())
        );
        panelShadow5Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelShadow5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(barChart, javax.swing.GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(panelShadow4, javax.swing.GroupLayout.PREFERRED_SIZE, 1263, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(panelShadow4, javax.swing.GroupLayout.PREFERRED_SIZE, 376, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel24)
                .addGap(24, 24, 24)
                .addComponent(panelShadow5, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
